...
from home.views import index,menu,about,menumore,add_reservation,booking_confirm,predict_image,pred_menu,booking_list,orders_lists,cancel_booking,download_pdf,download_bill,cancel_order,review,add_review,catering_booking,catering_details,save_catering,catering_booking_details
...
urlpatterns = [
    ...
    path('catering_payment/<int:catering_id>/', catering_payment, name='catering_payment'),
